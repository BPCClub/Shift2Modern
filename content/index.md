...
#description
The only guide you need to let your teammates adopt modern workflows and tools.

带您的队友采用现代开发工作流所需的唯一指南。

#links
  ::u-button{to="/preface" size="xl"}
  开始阅读
  ::

  ::u-button{to="https://github.com/orgs/BPCClub/projects/2/views/1" target="_blank" color="neutral" variant="subtle" size="xl"}
  查看线路图 →
  ::
::
